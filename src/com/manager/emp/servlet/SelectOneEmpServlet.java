...
public class SelectOneEmpServlet extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (emp == null) {
            request.getRequestDispatcher("/emp/selectOneFaild.jsp").forward(request, response);
        } else {
            request.setAttribute("emp", emp);
            request.getRequestDispatcher("/emp/selectOneSuccess.jsp").forward(request, response);
        }
    }
